...
const Signup = () => {
  ...
  const validateForm = () => {
    ...
    if (currentStep === 2) {
      ...
      if (!formData.addressProofImage)
        newErrors.addressProofImage = "Address proof is required";
  ...
  // Take live photo
  const takeSelfie = () => {
    // In a real app, this would use the webcam API
    alert("Webcam would open here to take a selfie");
  };
  // Render progress bar
      ...
      <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div>
            ...
            <div
              className={`border-2 border-dashed ${
                errors.addressProofImage ? "border-red-500" : "border-gray-300"
              } rounded-lg p-4 text-center`}
            >
              <input
                type="file"
                ...
                accept="image/*"
              />
              <label htmlFor="addressProofImage" className="cursor-pointer">
                <div className="flex flex-col items-center justify-center">
                  <i className="fas fa-upload text-gray-400 text-2xl mb-2"></i>
                  <p className="text-sm text-gray-500">
